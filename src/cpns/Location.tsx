  ...
  return (
    <div className="location relative">
      ...
      <div className="relative bg-amber-100 w-full">
        <span className="sec_title absolute bottom-0 left-2/5 text-xl -translate-x-12 opacity-0">Location</span>
      ...
      <div className="content pt-50 w-full opacity-0">
        <div className="box box1 relative overflow-hidden h-[350px] w-full">
          <div className="bg bg-[url('/brand-area3-1.jpg')] bg-cover size-full" style={{ backgroundPositionX: "80%" }}></div>
        ...
        <div className="box box2 relative overflow-hidden h-[350px] w-full">
          <div className="bg bg-[url('/brand-area3-2.jpg')] bg-cover size-full"  style={{ backgroundPositionX: "20%" }}></div>
